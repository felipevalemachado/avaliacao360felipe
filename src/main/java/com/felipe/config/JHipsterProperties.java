...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "avaliacao360felipe@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "avaliacao360felipe API";

        private String description = "avaliacao360felipe API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "avaliacao360felipe";
